...
export const Navbar = () => {
  ...
  return (
    <header className="bg-white max-w-screen-2xl mx-auto p-4 text-primary md:px-14">
      <nav className="container mx-auto flex items-center justify-between text-lg font-medium">
          ...
          <ul className="hidden space-x-12 md:flex ">
            {navItems.map(({ link, path }) => (
              <a
                key={link}
                href={path}
                className="block transition duration-400 hover:text-secondary"
              >
                {link}
              </a>
            ))}
        ...
        <div className="hidden space-x-12 items-center md:flex">
          <a
            href="/"
            className="hidden items-center transition duration-400 hover:text-secondary lg:flex"
          >
